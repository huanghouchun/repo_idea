 ...
 * @description VO --> View Object 表示表现层对象：主要用于表现层接收参数的实体
 * 以后如果在开发过程中看见有以 VO 进行命名的实体，它就是封装 浏览器发送给表现层的一些请求参数的实体
 */
/*
    VO: View Object 表现层对象 作用：在表现层接收前台参数的
 */
public class CourseVO {
    ...
    //课程名称
    private String courseName; // 驼峰命名 course_name 自动映射到 courseName
